...
def build_vlm_scene_runtime_state(
    *,
    mission_id: str = "",
    mission_type: str = "semantic_navigation",
    task_label: str = "",
    ...
    room_type_hint: str = "",
    occlusion_summary: str = "",
    unexplored_direction: str = "",
    confidence: float = 0.0,
    updated_at: Optional[str] = None,
) -> Dict[str, Any]:
    """Build a normalized VLM-style scene description runtime snapshot."""
    return {
        "schema_version": "phase6.vlm_scene_runtime.v1",
        "mission_id": str(mission_id or ""),
        "mission_type": str(mission_type or "semantic_navigation"),
        "task_label": str(task_label or ""),
        "status": str(status or "idle"),
        ...
        "scene_tags": [str(item) for item in (scene_tags or [])],
        "scene_state": str(scene_state or "unknown"),
        "entry_visible": bool(entry_visible),
        "entry_traversable": bool(entry_traversable),
        "room_type_hint": str(room_type_hint or ""),
        "occlusion_summary": str(occlusion_summary or ""),
        "unexplored_direction": str(unexplored_direction or ""),
        "confidence": float(confidence),
        "updated_at": updated_at or now_timestamp(),
    }


def build_reference_match_runtime_state(
    *,
    mission_id: str = "",
    task_label: str = "",
    status: str = "idle",
    ...
    """Build a normalized target-house reference matching runtime snapshot."""
    return {
        "schema_version": "phase6.reference_match_runtime.v1",
        "mission_id": str(mission_id or ""),
        "task_label": str(task_label or ""),
        "status": str(status or "idle"),
        "source": str(source or "none"),
        ...
        "match_state": str(match_state or "unknown"),
...
def build_semantic_archive_runtime_state(
    *,
    mission_id: str = "",
    status: str = "idle",
    source: str = "none",
    ...
    """Build a normalized semantic archive runtime snapshot."""
    return {
        "schema_version": "phase6.semantic_archive_runtime.v1",
        "mission_id": str(mission_id or ""),
        "status": str(status or "idle"),
        "source": str(source or "none"),
...
def build_phase6_waypoint_runtime_state(
    *,
    status: str = "idle",
    source: str = "phase6_waypoint_planner",
    scene_state: str = "unknown",
    active_stage_id: str = "outside_localization",
    active_goal: str = "",
    control_mode: str = "planner_waypoint",
    waypoint_queue: Optional[List[Dict[str, Any]]] = None,
    selected_waypoint: Optional[Dict[str, Any]] = None,
    candidate_count: int = 0,
    traversable_entry_count: int = 0,
    target_house_match_state: str = "unavailable",
    target_house_match_confidence: float = 0.0,
    ...
    """Build a normalized Phase 6 waypoint-planner runtime state."""
    return {
        "schema_version": "phase6.waypoint_runtime.v1",
        "status": str(status or "idle"),
        "source": str(source or "phase6_waypoint_planner"),
        "scene_state": str(scene_state or "unknown"),
        "active_stage_id": str(active_stage_id or "outside_localization"),
        "active_goal": str(active_goal or ""),
        "control_mode": str(control_mode or "planner_waypoint"),
        "waypoint_queue": waypoint_queue or [],
        "selected_waypoint": selected_waypoint or {},
        "candidate_count": int(candidate_count),
        "traversable_entry_count": int(traversable_entry_count),
        "target_house_match_state": str(target_house_match_state or "unavailable"),
        "target_house_match_confidence": float(target_house_match_confidence),
...
def build_plan_request(
    *,
    ...
    phase6_waypoint_runtime: Optional[Dict[str, Any]] = None,
    ...
    return {
        ...
        "vlm_scene_runtime": vlm_scene_runtime or {},
        "reference_match_runtime": reference_match_runtime or {},
        "semantic_archive_runtime": semantic_archive_runtime or {},
        "phase5_mission_manual": phase5_mission_manual or {},
        "phase6_mission_runtime": phase6_mission_runtime or {},
        "phase6_waypoint_runtime": phase6_waypoint_runtime or {},
